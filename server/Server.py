            ...
            if pid == 0:
                ...
                if user_name in user_dict:
                    if user_dict[user_name] == user_pass:
                        ...
                        sym_key = key_gen()
                        #print(sym_key)
                        c_key_file = open(os.getcwd() + "/"+user_name+"/"+user_name+"_public.pem", "rb")
                    ...
                    while bool_condition:
                        ...
                        if client_respond == "1":
                            ...
                            for i in range(len(destination)):
                                client_dir = (cwd + "/" + destination[i] + "/inbox/")
                            ...
                            if email_count >= 1 and choice >= 1 and choice <= email_count:
                                email_file = entries[int(choice) - 1]
                                # open email file
                                try:
                                    email = open(cwd + "/" + user_name + '/inbox/' + str(email_file))
